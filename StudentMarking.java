...
public class StudentMarking {
    ...
    public String generateStudId(Scanner sc) {
        //  (3.4) - Complete the generateStudId method which will allow a user to generate a student id
        String name, studId; //  Don't have unnecessary initialisations
        String firstName = "";
        String lastName = "";
        char midOfFirst;
        char midOfLast;
        ...
        midOfLast = lastName.charAt(lastnameLenght / 2);

        studId = String.format(STUDENT_ID_TEMPLATE,
                firstnameInitial, lastnameInitial, lastnameLenght, midOfFirst, midOfLast);
...
//        }
//        while (printLow > 0) {
//            System.out.printf(COLUMN_2_TEMPLATE, COLUMN_CHAR);
//            printLow--;
//            System.out.printf("%n");
//        }
...
//            } else if (choice == 2) {
//                System.out.printf("Please enter the studId to capture their marks (Enter 0 to return to main menu)%n");
//                String insertStudId = sc.nextLine();
//                int y;
//                for (y = 0; y < MAX_STUDENTS; y++) {
//                    if (insertStudId.equals(keepStudId[y])) {
//                        correctStudId = insertStudId;
//                        break;
//                    }
//                }
//                if (correctStudId != null)
//                    avgArray[y] = sm.captureMarks(sc, correctStudId);
//                else
//                    System.out.printf(sm.NOT_FOUND_TEMPLATE, insertStudId);
//            } else if (choice == 3)
//                sm.reportPerStud(keepStudId, numOfStud, avgArray);
